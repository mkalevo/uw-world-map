...
// e.g. http://127.0.0.1:5500/frontend/index.html?id=19 or https://website-url.com?id=19
const urlParams = new URLSearchParams(window.location.search)
const campaignId = urlParams.get("id")

// ---------- Fetch Data from Your Own Backend ----------
fetch('http://127.0.0.1:4000/map_data', {
  method: "POST",
